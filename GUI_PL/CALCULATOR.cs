...
namespace GUI_PL
{
    public partial class CALCULATOR : Form
    {
        ...
        public CalThreeLayer.BUS_BL.controlForm controlForm
        {
            get => default;
            set
            {
        ...
        private void bt_Chianghichdao_Click(object sender, EventArgs e)
        {
            tb_Result.Text = (1 / Convert.ToDouble(tb_Result.Text)).ToString();
            labelShow.Text = "";
        }

        private void bt_xbinh_Click(object sender, EventArgs e)
        {
            double a;
